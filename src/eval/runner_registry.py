...
MATHS_RUNNERS: tuple[RunnerSpec, ...] = (
    _runner(
        ...
        is_cot=False,
        extra_args=("--judge-mode", "exact", "--cot-mode", "no_cot"),
        batch_flag="--batch-size",
        probe_flag="--probe-only",
        probe_dataset_required=True,
        probe_question_floor=TARGET_EVAL_ATTEMPTS,
    ...
    _runner(
        ...
        module="src.eval.tasks.maths.runner",
        is_cot=False,
        extra_args=("--judge-mode", "exact", "--cot-mode", "no_cot", "--prompt-profile", "naive"),
        batch_flag="--batch-size",
        probe_flag="--probe-only",
        probe_dataset_required=True,
        probe_question_floor=TARGET_EVAL_ATTEMPTS,
    ...
    _runner(
        ...
        module="src.eval.tasks.maths.runner",
        is_cot=False,
        extra_args=("--judge-mode", "llm", "--cot-mode", "no_cot"),
        batch_flag="--batch-size",
        probe_flag="--probe-only",
        probe_dataset_required=True,
        probe_question_floor=TARGET_EVAL_ATTEMPTS,
    ...
    _runner(
        ...
        module="src.eval.tasks.maths.runner",
        is_cot=False,
        extra_args=("--judge-mode", "llm", "--cot-mode", "no_cot", "--prompt-profile", "naive"),
        batch_flag="--batch-size",
        probe_flag="--probe-only",
        probe_dataset_required=True,
        probe_question_floor=TARGET_EVAL_ATTEMPTS,
