...
DEFAULT_ADMIN_STATE_DIR = _path_env("RUN_ADMIN_STATE_DIR", RESULTS_ROOT / "scheduler-admin")
...
DEFAULT_ADMIN_HOST = os.environ.get("RUN_ADMIN_HOST", "127.0.0.1")
DEFAULT_ADMIN_PORT = int(os.environ.get("RUN_ADMIN_PORT", "8787"))
DEFAULT_ADMIN_API_KEY = os.environ.get("RUN_ADMIN_API_KEY") or os.environ.get("RWKV_EVAL_ADMIN_API_KEY")
